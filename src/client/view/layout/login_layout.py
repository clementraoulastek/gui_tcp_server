...
from src.client.core.qt_core import QHBoxLayout, QLabel, Qt, QWidget, QIcon, QVBoxLayout, QSizePolicy, QGridLayout, QLineEdit
...
class LoginLayout(QHBoxLayout):
    def __init__(self, parent=None):
        ...
        self.username_entry = CustomQLineEdit(place_holder_text="Enter your username", border_size=1)
        self.username_entry.setFixedWidth(300)
        self.password_entry = CustomQLineEdit(place_holder_text="Enter your password", border_size=1)
